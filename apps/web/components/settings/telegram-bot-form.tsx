...
export function TelegramBotForm({
  ...
  async function onSubmit(data: TelegramBotFormValues) {
    try {
      // 首先验证 Token
      const validationResult = await telegramBotService.validateToken(
        data.apiKey
      );
      ...
      if (!validationResult.success) {
        toast({
          ...
          title: "验证失败",
          description:
            validationResult.message || "Token验证失败，请检查输入是否正确",
        });
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>这将显示在您的Bot列表中</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>从BotFather获取的API密钥</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>为您的Bot添加简短描述</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
